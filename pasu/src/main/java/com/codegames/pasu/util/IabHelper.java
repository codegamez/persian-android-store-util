...
public class IabHelper {
    ...
    public String marketAppPackage;
     ...
     */
    public IabHelper(Context ctx, String base64PublicKey, String marketAppId, String marketAppPackage) {
        this.marketAppId = marketAppId;
        this.marketAppPackage = marketAppPackage;
